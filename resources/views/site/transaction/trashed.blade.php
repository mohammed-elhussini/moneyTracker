                ...
                <div class="card card-custom gutter-b">
                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-separate"
                            ...
                            <tbody>
                            @foreach ($userTransactionsTrash as $transaction)
                                <tr>
                                    <td>{{$loop->index}}</td>
                    ...
                    <span class="svg-icon svg-icon-md">
                        <i class="icon-xl la la-eye"></i>
                                        ...
                                        <a href="{{route('transaction.restore',$transaction->id)}}"
                        ...
                        <span class="svg-icon svg-icon-md">
                            <i class="icon-x text-dark-50 flaticon-refresh"></i>
                                        ...
                                        <form class="d-inline-flex"
                                              method="post"
                                              action="{{route('transaction.forceDelete',$transaction->id)}}">
                                            @csrf
                                            @method('delete')
                                            <button type="submit"
                                                    class="btn btn-sm btn-clean btn-icon"
